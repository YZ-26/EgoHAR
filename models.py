...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        x_ff = self.linear2(nn.ReLU()(self.linear1(x)))
        x = self.norm2(x + x_ff)
        return x
...
class TransformerClassifier(nn.Module):
    def __init__(self, num_classes, input_dim=4900, embed_dim=512, num_heads=1, hidden_dim=100, num_layers=1): # embed_dim: From EffNet output, 6x7x7
